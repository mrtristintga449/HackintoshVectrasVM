...
Change "-device isa-applesmc,osk=ourhardworkbythesewordsguardedpleasedontsteal\(c\)AppleComputerInc" To "(c)" And Then Escape The Parentheses (   \. (   and \. ) ) Since QEMU Wont Run (c)
